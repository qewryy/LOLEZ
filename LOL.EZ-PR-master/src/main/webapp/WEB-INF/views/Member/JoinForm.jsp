                    ...
                    <div class="contact-form-wrapper">
                        ...
                        <form action="#" class="contact-form">
                            <div class="row ">
                                ...
                                <!-- Button -->
                                <div class="col-lg-6">
                                    <button name="submit" class="submit-btn">취소</button>
                                </div>
                                  <div class="col-lg-6">
                                    <button name="submit" class="submit-btn">가입하기</button>
                                </div>
                                <span">이미 회원이신가요? </span> <a href="${pageContext.request.contextPath }/LoginForm" style="color: #f15f22; text-align: left;">로그인 하기</a>
                            </div>
                        </form>	
                    </div>
                </div>
