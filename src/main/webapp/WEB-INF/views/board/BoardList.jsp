		...
		<section id="services" class="services">
			<div class="row justify-content-center "
				...
				<div class="p-5">
					...
					<form class="row g-3"	action="${pageContext.request.contextPath }/boardWrite"	enctype="multipart/form-data" method="post" class="user">
						<%-- <input type="hidden" name="bwiter" value="${sessionScope.loginInfo.mid }"> --%>
